...
/**
 * Base {@link InstantiatorStrategy} class basically containing helpful
 * constant to sort out JVMs.
 * 
...
public abstract class BaseInstantiatorStrategy implements InstantiatorStrategy {
	...
	/** JVM version */
	protected static final String VM_VERSION = System
	...
	/** Vendor version */
	protected static final String VENDOR_VERSION = System
